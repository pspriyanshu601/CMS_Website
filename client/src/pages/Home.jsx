    ...
    <div>
      ...
      <section className="py-20 px-4 text-center">
        <div className="container mx-auto">
          <h1 className="text-4xl font-bold mb-4">Welcome to My CMS</h1>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 border border-gray-300 rounded-lg">
              <h3 className="text-xl font-bold mb-4">Save Time and Effort</h3>
              <p>
            ...
            <div className="p-6 border border-gray-300 rounded-lg">
              <h3 className="text-xl font-bold mb-4">Increase Productivity</h3>
              <p>
